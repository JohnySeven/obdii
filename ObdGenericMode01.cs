    ...
    public class ObdGenericMode01 : AbstractObdMode
    {
        ...
        public double EngineOilTemperature
        {
            get
            {
                ...
                string[] reading = this.GetPidResponse("5C");
        ...
        public double EngineRpm
        {
            get
            {
                ...
                if (reading.Length > 1)
                {
                    var a = int.Parse(reading[0], System.Globalization.NumberStyles.HexNumber);
                    var b = int.Parse(reading[1], System.Globalization.NumberStyles.HexNumber);
        ...
        public bool? EngineMil
        {
            get
            {
                ...
                string[] reading = this.GetPidResponse("01");
                if (reading.Length > 1)
                {
                    var a = int.Parse(reading[0], System.Globalization.NumberStyles.HexNumber);
        ...
        public double MassAirFlowRate
        {
            get
            {
                ...
                var reading = this.GetPidResponse("10");

                return
                    reading.Length > 1 ? ((Util.ConvertHexToInt(reading[0]) * 256) + Util.ConvertHexToInt(reading[1])) / 100 :
                    0;
            }
        }
